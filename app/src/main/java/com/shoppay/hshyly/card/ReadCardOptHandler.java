package com.shoppay.hshyly.card;
...
import com.shoppay.hshyly.MyApplication;
 ...
 * 联系方式QQ：398320879
 */
public class ReadCardOptHandler extends Activity {
  ...
  private Handler back;
     ...
     *
     */
    public ReadCardOptHandler(Handler handler) {
         back=handler;
            ...
            switch (msg.what) {
                case 0x01:
                    ...
                    if (payCardInfo.cardType == 8) {
                        ...
                        Message msgs=back.obtainMessage();
                        msgs.obj=mCardNumber;
                        msgs.what=8;
                        back.sendMessage(msgs);
